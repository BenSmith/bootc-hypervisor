#!/usr/bin/env python3
"""Unit tests for workload-ctl update/rollback functionality."""
...
# Import workload-ctl as a module (hyphenated filename requires importlib)
LIB_DIR = os.path.join(os.path.dirname(__file__), '..', 'lib')
sys.path.insert(0, LIB_DIR)

_ctl_path = os.path.join(os.path.dirname(__file__), '..', 'bin', 'workload-ctl')
